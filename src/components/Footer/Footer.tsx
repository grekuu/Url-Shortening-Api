    ...
    <>
      ...
      <div className="footer-bottom">
        ...
        <div className="socials">
          <AiFillFacebook className="social"></AiFillFacebook>
          <AiOutlineTwitter className="social"></AiOutlineTwitter>
          <BsPinterest className="social"></BsPinterest>
          <AiOutlineInstagram className="social"></AiOutlineInstagram>
        </div>
      </div>
    </>
  );
